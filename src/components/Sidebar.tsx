...
const NAV = [
  ...
  {
    href: "/alerts",
    icon: ExtraIcons.alert,
    label: "Alerts",
    roles: ["user", "officer", "admin"],
  },
  {
    href: "/anomalies",
    icon: ExtraIcons.anomaly,
    label: "Anomalies",
    roles: ["officer", "admin"],
  },
  {
    href: "/surveys",
    icon: ExtraIcons.survey,
    label: "Surveys",
    roles: ["officer", "admin"],
  },
  {
    href: "/regions",
    icon: ExtraIcons.region,
    label: "Regions",
    roles: ["officer", "admin"],
  },
  {
    href: "/conservation",
    icon: ExtraIcons.conservation,
    label: "Conservation Zones",
    roles: ["officer", "admin"],
  },
  {
    href: "/documents",
    icon: ExtraIcons.document,
    label: "Documents",
    roles: ["user", "officer", "admin"],
  },
  {
  ...
  {
    href: "/notifications",
    icon: ExtraIcons.notification,
    label: "Notifications",
    roles: ["user", "officer", "admin"],
  },
  {
    href: "/users",
    icon: ExtraIcons.users,
    label: "User Directory",
    roles: ["officer", "admin"],
  },
  {
    href: "/officer",
    icon: ExtraIcons.officer,
    label: "Officer Panel",
    roles: ["officer", "admin"],
  },
...
const KestrelIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path
      d="M12 2L4 8v4l4-2v4l4 4 4-4v-4l4 2V8L12 2z"
      fill="white"
      opacity="0.9"
    />
          ...
          <div className="sidebar-user-info">
            ...
            <div className="sidebar-user-role">
              ...
              {user.contributionScore > 0 && (
                <span style={{ marginLeft: 6, color: "#5cb887" }}>
                  · {user.contributionScore} pts
                </span>
              )}
            </div>
          </div>
