...
const GROQ_MODELS = [
  {
    ...
    name: "LLaMA 3.1 8B",
    context: "131K context • 560 T/s • Fast & Affordable",
  },
  {
    id: "llama-3.3-70b-versatile",
    name: "LLaMA 3.3 70B",
    context: "131K context • 280 T/s • Best Quality",
  },
  {
    id: "openai/gpt-oss-120b",
    name: "OpenAI GPT-OSS 120B",
    context: "131K context • 500 T/s • Flagship Model",
  },
  {
    id: "openai/gpt-oss-20b",
    name: "OpenAI GPT-OSS 20B",
    context: "131K context • 1000 T/s • Fastest",
  },
];
          ...
          <div className="topbar">
            <div>
              ...
              <div className="topbar-subtitle">
                Powered by Groq - Ask questions about your documents
              </div>
            </div>
              ...
              >
                {messages.length === 0 && (
                  ...
                  >
                    ...
                    <p style={{ fontSize: 14 }}>
                      Upload documents and ask questions, or just chat with the
                      AI assistant
                    </p>
                  </div>
                )}
                ...
                {messages.map((msg, idx) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {msg.tokensUsed && (
                        <div
                          style={{ fontSize: 10, opacity: 0.6, marginTop: 6 }}
                        >
                ...
                {selectedDocument && (
                  ...
                  >
                    ...
                    <span>
                      Context:{" "}
                      {
                        documents.find((d) => d._id === selectedDocument)
                          ?.fileName
                      }
                    </span>
                    <button
                  ...
                  {documents.map((doc) => (
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: 6,
                        background:
                          selectedDocument === doc._id ? "#e8f5ee" : "#f9fafb",
