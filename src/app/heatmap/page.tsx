  ...
  const loadHeatmap = async (zoom?: number) => {
    ...
    try {
      ...
      if (res.data.aggregated) {
        toast.success(
          `Loaded ${res.data.count} reports aggregated into ${res.data.gridCount} grid cells (${res.data.precision}° precision)`,
        );
      } else {
      ...
      <div className="app-shell">
        ...
        <div className="main-content">
          <div className="topbar">
            <div>
              ...
              <div className="topbar-subtitle">
                Interactive geographical distribution visualization
              </div>
            </div>
          </div>
          ...
          <div
            ...
            style={{ padding: 0, height: "calc(100vh - 70px)" }}
          >
            {/* Filter Panel */}
            <div
              style={{
            ...
            >
              ...
              <div
                style={{
                  marginBottom: 12,
                  padding: 10,
                  background: timelineEnabled ? "#dbeafe" : "#f3f4f6",
                  borderRadius: 6,
                  border: timelineEnabled ? "2px solid #3b82f6" : "none",
                }}
              >
                <label
                  style={{
              ...
              <div className="form-group" style={{ marginBottom: 10 }}>
                ...
                <input
                  ...
                  style={{
                    fontSize: 12,
                    padding: "6px 8px",
                    opacity: timelineEnabled ? 0.5 : 1,
                    cursor: timelineEnabled ? "not-allowed" : "text",
                  }}
                />
              </div>
